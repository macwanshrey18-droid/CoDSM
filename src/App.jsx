...
export default function App() {
  ...
  // 1-Minute Timer: Auto-transition 'REQUEST_SENT' to 'ACCEPTED' after 60 seconds if worker hasn't manually responded
  useEffect(() => {
    let timer;
  ...
  return (
    <div className="min-h-screen h-screen w-full bg-slate-50 sm:bg-slate-950 flex flex-col items-center justify-center p-0 sm:p-6 text-slate-900 overflow-hidden">
      {/* Outer Title */}
